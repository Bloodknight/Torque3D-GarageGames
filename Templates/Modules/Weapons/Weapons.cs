...
//the Weapons.module file, which contains our module definition. It is called
...
{
   echo("Destroyed module: " @ %this.name );
}
...
function Weapons::initServer(%this)
{
...
function Weapons::onCreateGameServer(%this)
{
   ...
   %this.registerDatablock("./datablocks/SFXDescription.cs");
   %this.registerDatablock("./datablocks/SFXProfile.cs");

   // Generic and Shared datablocks
   %this.registerDatablock("./datablocks/weapon.cs"); 

   // Each weapon needs its own datablock these should be added here
...
function Weapons::onDestroyGameServer(%this)
{
...
//and the like
function Weapons::initClient(%this)
{ 
...
function Weapons::onCreateClientConnection(%this)
{ 
}
...
function Weapons::onDestroyClientConnection(%this)
{ 
}
